    ...
    <ul id="slide-out" class="sidenav">
        <li>
            ...
            <a class="modal-trigger" href="#notifica"><img src="../img/notifica.png" class="notifica"></a>
                <div class="modal modal-fixed-header" id="notifica">
                    ...
                    <div class="modal-content">
                        <ul class="collection lista_notificação">
                            ...
                            <a href="../aluno/tcc.php" class="collection-item red-text text-darken-2">Seu TCC foi aprovado e postado na biblioteca! Parabens <br><b>Análise de TCC</b></a>
                ...
                <div class="total_notifica">3</div>
        ...
        <li><a href="entrega.php"><i class="material-icons"><img src="../icon/entrega.png" class="icone">entregar</i>Entregar TCC</a></li>
        <div class="divider"></div>
...
<!-- navbar -->
    <div class="nav">
        ...
        <h4 class="local_atual"><b>DESENVOVIMENTO</b></h4>
        <div class="pesquisa">
