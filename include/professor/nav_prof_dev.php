...
<head>
    ...
    <link rel="stylesheet" href="../css/professor/prof.css">
    ...
    <ul id="slide-out" class="sidenav">
        <li>
            ...
            <a class="modal-trigger" href="#notifica"><img src="../img/notifica.png" class="notifica"></a>
                <div class="modal modal_notifica" id="notifica">
                    <div class="modal-header modal_header_notifica">
                    ...
                    <div class="modal-content modal_conteudo_notifica">
                ...
                <section class="nomealuno">
                    <a href="../professor/perfil_prof.php"><img src="../img/prof.png" class="menuperfil"></a>
                    <a href="perfil_prof.php"><span class="white-text name">Graciete Henriques</span></a>
                    <a href=""><span class="white-text email">Professor(a)</span></a> 
                </section>
            </div>
        </li>
        ...
        <li><div class="divider"></div></li>
        <li><a href="cadastro.php"><i class="material-icons"><img src="../icon/cadastro.png" class="icone">equipe</i>Cadastros</a></li>
        <div class="divider"></div>
        <li><a href="entrega.php"><i class="material-icons"><img src="../icon/entrega.png" class="icone">entregar</i>Entrega de TCC</a></li>
        <div class="divider"></div>
...
<!-- navbar -->
    <div class="nav">
        ...
        <h4 class="local_atual"><b>DESENVOLVIMENTO</b></h4>
        <div class="pesquisa">
        ...
        <div class="conteudo">
            <div class="linha"></div>
            <a href="../professor/perfil_prof.php" class="foto"></a>
            <div class="coluna">
                <div class="login"><b>Graciete Henriques</b></div>
                <div class="mod">Professora</div>
            </div>
        </div>    
    </div>
<!-- fim da navbar -->
