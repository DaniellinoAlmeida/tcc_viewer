...
<!-- side nav -->
    <ul id="slide-out" class="sidenav">
        ...
        <li><div class="divider"></div></li>
        <li><a href="equipe.php"><i class="material-icons"><img src="../icon/cadastro.png" class="icone">equipe</i>Cadastros</a></li>
        <div class="divider"></div>
        <li><a href="entregaTcc´.php"><i class="material-icons"><img src="../icon/entrega.png" class="icone">entregar</i>Entrega de TCC</a></li>
        <div class="divider"></div>
...
<!-- navbar -->
    <div class="nav">
        ...
        <h4 class="local_atual"><b>ENTREGA DE TCC</b></h4>
        <div class="pesquisa">
